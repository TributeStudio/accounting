            ...
            <aside className="w-64 bg-slate-900 text-white flex flex-col p-6 shadow-2xl">
                <div className="flex items-center gap-3 mb-12">
                    <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center">
                        <span className="text-slate-900 font-serif font-bold text-xl">T</span>
                    </div>
                    <div>
                        <h1 className="text-xl font-serif font-bold tracking-tight">Tribute</h1>
                ...
                <nav className="flex-1 space-y-2">
                    ...
                    <SidebarItem to="/ai-statement" icon={Sparkles} label="Statement AI" />
                    <SidebarItem to="/invoices" icon={FileText} label="Invoices" />
                    <SidebarItem to="/projects" icon={ClipboardList} label="Projects" />
                </nav>
